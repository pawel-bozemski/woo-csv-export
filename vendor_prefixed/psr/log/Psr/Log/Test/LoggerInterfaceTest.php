...
namespace CSVExporterVendor\Psr\Log\Test;

use Psr\Log\LoggerInterface;
use Psr\Log\LogLevel;
use CSVExporterVendor\PHPUnit\Framework\TestCase;
/**
 ...
 */
abstract class LoggerInterfaceTest extends \CSVExporterVendor\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $this->assertInstanceOf('CSVExporterVendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('CSVExporterVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('CSVExporterVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
    ...
    public function testContextCanContainAnything()
    {
        ...
        \fclose($closed);
        $context = array('bool' => \true, 'null' => null, 'string' => 'Foo', 'int' => 0, 'float' => 0.5, 'nested' => array('with object' => new \CSVExporterVendor\Psr\Log\Test\DummyTest()), 'object' => new \DateTime(), 'resource' => \fopen('php://memory', 'r'), 'closed' => $closed);
