...
if (!\interface_exists('CSVExporterVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('CSVExporterVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \CSVExporterVendor\WPDesk_Translatable, \CSVExporterVendor\WPDesk_Buildable, \CSVExporterVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
