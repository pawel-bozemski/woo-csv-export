 ...
 */
class InfoBuilder extends \CSVExporterVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\CSVExporterVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
