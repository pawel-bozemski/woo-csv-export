...
<h2><?php 
\printf(\esc_html__('You are deactivating %s plugin.', 'csv-exporter'), \esc_html($plugin_name));
?></h2>
...
<div class="wpdesk_tracker_deactivate">
	<div class="body">
		...
		<div class="panel active" data-panel-id="reasons">
			<h4><strong><?php 
\esc_html_e(' If you have a moment, please let us know why you are deactivating plugin (anonymous feedback):', 'csv-exporter');
?></strong></h4>
			<ul id="reasons-list">
                <li class="reason">
                    <label>
	            	<span>
                        ...
                        <span><?php 
\esc_html_e('The plugin suddenly stopped working', 'csv-exporter');
?></span>
                    </label>
                </li>
                <li class="reason">
	            	...
	            	<span>
                        ...
                        <span><?php 
\esc_html_e('The plugin broke my site', 'csv-exporter');
?></span>
                    </label>
                </li>
...
?>">
				...
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('I only needed the plugin for a short period', 'csv-exporter');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('I no longer need the plugin', 'csv-exporter');
?></span>
					</label>
				</li>
				<li class="reason">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('It\'s a temporary deactivation. I\'m just debugging an issue.', 'csv-exporter');
?></span>
					</label>
				</li>
				<li class="reason has-input">
	            	...
	            	<span>
						...
						<span><?php 
\esc_html_e('Other', 'csv-exporter');
?></span>
					</label>
					<div id="other" class="reason-input">
						<input type="text" name="other" placeholder="<?php 
\esc_attr_e('Kindly tell us the reason so we can improve', 'csv-exporter');
?>">
					</div>
				</li>
			</ul>
...
\esc_html_e('Submit &amp; Deactivate', 'csv-exporter');
?>' );
	})
