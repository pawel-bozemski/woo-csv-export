...
if (!\interface_exists('CSVExporterVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('CSVExporterVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \CSVExporterVendor\WPDesk_Requirement_Checker
    {
